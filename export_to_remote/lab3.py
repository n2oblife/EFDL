...
def part1():
    ...
    for i in range(11):
        ...
        prune.l1_unstructured(vgg16, name="bias", amount=prune_rate)
        ...
        with torch.no_grad():
            ...
            print('Accuracy of the network on the {} test images with pruning {}% of the network : {} %'.format(len(testloader.dataset), prun_rate,100 * correct / total))   
        rate.append(i)
